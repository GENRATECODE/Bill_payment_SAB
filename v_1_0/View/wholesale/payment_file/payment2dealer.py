...
import time
import base64
class payment_tab_fun(ft.Container):
    def __init__(self, app_layout,page):
        ...
        self.search_Dealer = ft.TextField(
                                            ...
                                            hint_text="Enter Dealer name",keyboard_type=ft.KeyboardType.NAME,
        ...
        self.search_address = ft.TextField( 
                                            ...
                                            border_radius=ft.border_radius.all(10),
                                           label="Address", 
                                           hint_text="Enter Dealer Address",
                                            label_style=ft.TextStyle( word_spacing=5,color="#6A1E55",size=16,shadow=ft.BoxShadow(
                                                spread_radius=1,
                                                blur_radius=15,
                                                color=ft.colors.BLUE_GREY_300,
        ...
        self.search_ID = ft.TextField(prefix_icon=ft.icons.PERM_IDENTITY_OUTLINED,
                                      ...
                                      label="Dealer ID ",
                                      hint_text="Company_Location_Mobile_GST ", 
                                      width=200,col={"sm": 6, "md": 4, "xl": 3})
        ...
        self.Dealer_address =ft.TextField( 
                                            selection_color="#526E48",
                                            focused_bgcolor="#C6E7FF",
                                            focused_color="#3B1E54",
                                            # prefix_text="MR/M ",
                                           ...
                                           hint_text="Enter address",
                                            label_style=ft.TextStyle( word_spacing=5,color="#6A1E55",size=16,shadow=ft.BoxShadow(
                                                ...
                                                offset=ft.Offset(0,0),blur_style=ft.ShadowBlurStyle.SOLID,)),keyboard_type=ft.KeyboardType.STREET_ADDRESS,
                                           width=200,col={"sm": 6, "md": 12, "xl": 3})
        self.Dealer_mobile =  ft.TextField(input_filter=ft.NumbersOnlyInputFilter(), 
                                           prefix_text=f"+{91 }",
                                            selection_color="#526E48",
                                            focused_bgcolor="#C6E7FF",
                                            focused_color="#3B1E54",
        ...
        # Entry Detail Fields
        self.amount = ft.TextField(col={"sm": 6, "md": 4, "xl": 2},label="Pay Amount", width=200,                                            selection_color="#526E48",
                                            focused_bgcolor="#C6E7FF",
                                            focused_color="#3B1E54",
                                            hint_text="15000.00",
                                            # prefix_text="MR/M ",
        ...
        self.remark = ft.TextField(col={"sm": 6, "md": 4, "xl": 2},label="Remark",width=200,multiline=True,keyboard_type=ft.KeyboardType.MULTILINE,
                                            ...
                                            label_style=ft.TextStyle( word_spacing=5,color="#6A1E55",size=16,shadow=ft.BoxShadow(
                                                ...
                                                color=ft.colors.BLUE_GREY_300,
                                                offset=ft.Offset(0,0),blur_style=ft.ShadowBlurStyle.SOLID,)),     )
        self.paid_by = ft.TextField(col={"sm": 6, "md": 4, "xl": 2},bgcolor="#EBEAFF",label="Paid By ", width=200,keyboard_type=ft.KeyboardType.NAME,
                                            selection_color="#526E48",
                                            focused_bgcolor="#C6E7FF",
                                            focused_color="#3B1E54",
                                            # prefix_text="MR/M ",
        ...
        self.invoice_date = ft.TextField(                                            selection_color="#526E48",
                                            ...
                                            label_style=ft.TextStyle( word_spacing=5,color="#6A1E55",size=16,shadow=ft.BoxShadow(
                                                ...
                                                color=ft.colors.BLUE_GREY_300,
                                                offset=ft.Offset(0,0),blur_style=ft.ShadowBlurStyle.SOLID,)),
                                            border_radius=ft.border_radius.all(10),keyboard_type=ft.KeyboardType.DATETIME,label="Payment Date",content_padding=8,suffix=ft.IconButton(
        ...
        self.content = ft.Column(
            [
                # ft.Divider(),
                ft.Text("Search Dealer By Dealer ID OR Dealer Detail", size=30, weight="bold", color="#133E87"),
                ft.ResponsiveRow([self.search_ID,self.opiton,self.search_Dealer, self.search_address, self.search_mobile,], spacing=10,alignment=ft.MainAxisAlignment.CENTER),
                search_button,
                ft.Divider(),
                ft.ResponsiveRow([self.Dealer_name,
                                    self.Dealer_address, 
                                    self.Dealer_mobile,self.amount, 
                                ], spacing=10),
    ...
    def lottie_files(self):
        with open(r"D:\Bill_payment_SAB\v_1_0\assets\josn_icon\submit.json", "rb") as lottie_file:
            lottie_base64_submit = base64.b64encode(lottie_file.read()).decode("utf-8")
        self.submit=ft.Lottie(src_base64=lottie_base64_submit,animate=True, fit='SCALE_DOWN',  width=100,  height=100,reverse=True )